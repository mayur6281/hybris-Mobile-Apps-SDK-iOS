//
//  HYImageCropperViewController.m
//  Hybris
//
...
@interface HYImageCropperViewController ()
...
@implementation HYImageCropperViewController
...
- (void)initControlBtn
{
    ...
    leftbutton.frame = CGRectMake(0, 0, 75, 32);
    ...
    rightbutton.frame = CGRectMake(0, 0, 55, 36);
    ...
    self.navigationItem.rightBarButtonItem = customBarrightItem;
...
- (void)cancel:(id)sender {
    ...
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(HYImageCropperDelegate)]) {
