...
@interface HYProfileViewController:HYTableViewController<ModalViewControllerDelegate, AccHealthDataCollectorDelegate,CLLocationManagerDelegate>
...
//For Geolocation for sending location.
